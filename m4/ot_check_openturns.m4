...
#  Id:      $Id: ot_check_openturns.m4 1539 2012-02-27 13:48:06Z schueller $
#  serial   0.11.0
#
#
...
[
  ...
  then
    ...
    if test -z "$ot_cv_openturns_config_script" || test -z "$ot_cv_openturns_install_path" || test -z "$ot_cv_openturns_cppflags" || test -z "$ot_cv_openturns_ldflags" || test -z "$ot_cv_openturns_libs" || test -z "$ot_cv_openturns_wrapper_cppflags" || test -z "$ot_cv_openturns_wrapper_ldflags" || test -z "$ot_cv_openturns_wrapper_libs"
    then
