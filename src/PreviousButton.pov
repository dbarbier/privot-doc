// to compile:
// /usr/local/povray-3.7.0.rc3/bin/povray +L/usr/local/povray-3.7.0.rc3/share/povray-3.7/include/ +IPreviousButton.pov +H80 +W80 +Q9 +A0.1 +Am2 +UA
#include "colors.inc"
#include "metals.inc"
#include "glass.inc"
...
difference {
  object { b_round
    texture { Plastic }}
  object { c_rarrow translate <0.1,0,-0.1> rotate <0,0,180>
